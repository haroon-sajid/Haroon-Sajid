...
const About = () => {
    ...
    return (
        ...
        >
            ...
            <div className="relative z-10 flex flex-col lg:flex-row items-stretch gap-8 sm:gap-16 lg:gap-20 mt-8 sm:mt-16 lg:mt-20">
                ...
                >
                    ...
                    >
                        ...
                        <div className="absolute bottom-0 left-0 right-0 h-32 sm:h-48 overflow-hidden pointer-events-none opacity-20 dark:opacity-30">
                            <svg
                                className="absolute bottom-0 w-full h-32 sm:h-48 fill-primary"
                        ...
                        {/* Master Fade Overlay */}
                        <div className="absolute bottom-0 left-0 right-0 h-40 sm:h-56 bg-gradient-to-t from-slate-50 dark:from-gray-950 via-slate-50/80 dark:via-gray-950/80 to-transparent pointer-events-none" />
                    ...
                    {/* Floating stats card */}
                    <div className="absolute -bottom-6 sm:-bottom-10 -right-4 sm:-right-6 lg:-right-10 z-20 bg-white dark:bg-gray-900 p-4 sm:p-6 rounded-xl sm:rounded-2xl shadow-xl border border-gray-100 dark:border-gray-800">
                        <p className="text-2xl sm:text-4xl font-bold text-primary mb-0.5 sm:mb-1">1.5+</p>
                        <p className="text-xs sm:text-sm font-medium text-gray-500 uppercase tracking-wider">Years Experience</p>
                    </div>
                </div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                        <div className="flex items-start gap-3 sm:gap-4">
                            <div className="w-10 h-10 sm:w-12 sm:h-12 bg-primary/10 rounded-lg flex items-center justify-center shrink-0">
                                <svg className="w-5 h-5 sm:w-6 sm:h-6 text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M13 10V3L4 14h7v7l9-11h-7z"></path></svg>
                            </div>
                            <div>
                                <h4 className="font-bold text-sm sm:text-base text-black dark:text-white">Efficient Coder</h4>
                                <p className="text-xs sm:text-sm text-black dark:text-white">Delivering optimized and scalable solutions.</p>
                            </div>
                        </div>
                        <div className="flex items-start gap-3 sm:gap-4">
                            <div className="w-10 h-10 sm:w-12 sm:h-12 bg-primary/10 rounded-lg flex items-center justify-center shrink-0">
                            ...
                            <div>
                                <h4 className="font-bold text-sm sm:text-base text-black dark:text-white">Reliable Partner</h4>
                                <p className="text-xs sm:text-sm text-black dark:text-white">Committed to long-term project success.</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div className="relative z-10 mt-16 sm:mt-24 lg:mt-32 grid grid-cols-1 md:grid-cols-3 gap-8 sm:gap-12 py-10 sm:py-14 lg:py-16 
              border-y border-gray-200/50 dark:border-gray-800
              bg-white/50 dark:bg-gray-900/30 
              backdrop-blur-sm rounded-2xl sm:rounded-3xl px-6 sm:px-8
              shadow-lg shadow-gray-200/50 dark:shadow-black/20">
                <div className="flex flex-col items-center text-center group">
                    <div className="w-12 h-12 sm:w-16 sm:h-16 bg-primary/10 rounded-xl sm:rounded-2xl flex items-center justify-center mb-4 sm:mb-6 group-hover:scale-110 transition-transform duration-300">
                        <svg className="w-6 h-6 sm:w-8 sm:h-8 text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M10 20l4-16m4 4l4 4-4 4M6 16l-4-4 4-4" />
                        </svg>
                    </div>
                    <div>
                        <p className="text-3xl sm:text-4xl lg:text-5xl font-bold text-black dark:text-white mb-1 sm:mb-2">1.5+</p>
                        <p className="text-xs sm:text-sm font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-[0.2em]">Years Experience</p>
                    </div>
                </div>
                ...
                <div className="flex flex-col items-center text-center group">
                    <div className="w-12 h-12 sm:w-16 sm:h-16 bg-primary/10 rounded-xl sm:rounded-2xl flex items-center justify-center mb-4 sm:mb-6 group-hover:scale-110 transition-transform duration-300">
                        <svg className="w-6 h-6 sm:w-8 sm:h-8 text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M15.5 8.5L21 3m0 0l-5.5 0M21 3v5.5m-5.493 2.507a9.006 9.006 0 00-11 11L3 21l1.493-1.493a9.006 9.006 0 0011-11z" />
                        </svg>
                    </div>
                    <div>
                        <p className="text-3xl sm:text-4xl lg:text-5xl font-bold text-black dark:text-white mb-1 sm:mb-2">10+</p>
                        <p className="text-xs sm:text-sm font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-[0.2em]">Projects Completed</p>
                    </div>
                </div>
                ...
                <div className="flex flex-col items-center text-center group">
                    <div className="w-12 h-12 sm:w-16 sm:h-16 bg-primary/10 rounded-xl sm:rounded-2xl flex items-center justify-center mb-4 sm:mb-6 group-hover:scale-110 transition-transform duration-300">
                        <svg className="w-6 h-6 sm:w-8 sm:h-8 text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M17 21v-2a4 4 0 00-4-4H5a4 4 0 00-4 4v2m16-10a4 4 0 00-4-4H5a4 4 0 00-4-4h12c2.21 0 4 1.79 4 4v2m-6 0a3 3 0 11-6 0 3 3 0 016 0zm7-7a3 3 0 11-6 0 3 3 0 016 0z" />
                        </svg>
                    </div>
                    <div>
                        <p className="text-3xl sm:text-4xl lg:text-5xl font-bold text-black dark:text-white mb-1 sm:mb-2">15+</p>
                        <p className="text-xs sm:text-sm font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-[0.2em]">Technologies</p>
                    </div>
                </div>
            </div>
        </section>
